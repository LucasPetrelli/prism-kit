 ...
 * the application entry path and normal steady-state call depth comfortable headroom
 * without spending an unnecessarily large share of the board's limited RAM budget.
 */
