...
private:
	...
	/// @brief True once configure_word_stream() has successfully programmed a descriptor.
	bool configured_;
	...
	bool loop_forever_;
	/// @brief Optional callback invoked when completion/error interrupt is observed.
