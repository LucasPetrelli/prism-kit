...
private:
	...
	/// @brief Wakes the blocked writer once the pending request is drained into TX.
	mutable k_sem write_complete_;
	/// @brief Protects the shared pending-write state touched by writer and callback.
