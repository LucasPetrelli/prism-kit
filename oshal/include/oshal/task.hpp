...
/// @brief Sentinel returned when a best-effort stack usage value is not available.
...
struct TaskRuntimeSample {
	...
	/// @note This denominator follows the active backend's runtime-stat semantics.
